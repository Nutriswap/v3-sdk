import { BigintIsh, Token } from '@nutriswap/sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from '@nutriswap/v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
