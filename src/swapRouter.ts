...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@nutriswap/sdk-core'
...
import ISwapRouter from '@nutriswap/v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
